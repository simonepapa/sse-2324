...
<ul class="sidebar navbar-nav">
    <br>
      ...
      <li class="nav-item active" >
          <a class="nav-link dropdown-toggle" id="pagesDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#">
...
if (!empty($_POST['token']) && hash_equals($_SESSION['token'], $_POST['token'])) {
  if (isset($_POST['submit'])){   
    ...
    if ($idt && $grav !== null) {
      ...
      $first_query = "SELECT * FROM segnalazioni WHERE tipo = 5 AND id = ?";
...
<br><br>
    ...
    <script>
      ...
      if (isLogin) {
        document.getElementById("policyBanner").classList.remove("d-none")
        document.getElementById("policyBanner").classList.remove("d-none")
      }
      console.log(isLogin)
    </script>
