      ...
      <div class="row" style="margin-left:2%; margin-top:10%; margin-bottom: -6px;">
          ...
          <div class="card h-100" style="border:groove; border-color: black; ">
            ...
            <div class="card-body">
              <h4 class="me-5" style="margin-top: 20px;">
                <a href="segnalazioniverde.php" style="color:black"> Segnalazioni su aree verdi <i
                    class="fas fa-angle-right" style="margin-left:3px;"><i class="fas fa-angle-right"
                      style="margin-left:3px;"></i></i></a>
              </h4>
            </div>
          </div>
        </div>
          ...
          <div class="card h-100" style="border:groove; border-color: black; ">
            ...
            <div class="card-body">
              <h4 class="me-5" style="margin-top: -3px;"> <br>
                <a href="segnalazionirifiuti.php" style="color:black"> Rifiuti e pulizia stradale <i
                    class="fas fa-angle-right" style="margin-left:3px;"><i class="fas fa-angle-right"
                      style="margin-left:3px;"></i></i></a>
              </h4>
            </div>
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100" style="border:groove; border-color: black; ">
            ...
            <div class="card-body">
              <h4 class="me-5" style="margin-top: -3px;"> <br>
                <a href="segnalazionistrade.php" style="color:black"> Strade e marciapiedi <i class="fas fa-angle-right"
                    style="margin-left:3px;"><i class="fas fa-angle-right" style="margin-left:3px;"></i></i></a>
              </h4>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100" style="border:groove; border-color: black; margin-top:4%; ">
            ...
            <div class="card-body">
              <h4 class="me-5" style="margin-top: -3px;"> <br>
                <a href="segnalazionisemafori.php" style="color:black"> Segnaletica e semafori <i
                    class="fas fa-angle-right" style="margin-left:3px;"><i class="fas fa-angle-right"
                      style="margin-left:3px;"></i></i></a>
              </h4>
            </div>
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100" style="border:groove; border-color: black; margin-top:4%;  ">
            ...
            <div class="card-body">
              <h4 class="me-5" style="margin-top: -3px; "> <br>
                <a href="segnalazioniilluminazione.php" style="color:black"> Illuminazione pubblica <i
                    class="fas fa-angle-right" style="margin-left:3px;"><i class="fas fa-angle-right"
                      style="margin-left:3px;"></i></i></a>
              </h4>
            </div>
